    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", height: "100vh", justifyContent: "space-between" }}>
      <div className="settings">
        ...
        <input
          ...
          type="range"
        />
        <h1 style={{ color: colors.dark }}>Number of elements</h1>
        <input
          min={2}
          max={Math.floor(Math.sqrt(1000))}
          className="input"
      ...
      <div style={{ display: "flex", width: "80%", marginBottom: "0px", bottom: 0, alignItems: "flex-end" }}>
        {array.map((el, i) => (
          <div
            key={i}
            style={{
